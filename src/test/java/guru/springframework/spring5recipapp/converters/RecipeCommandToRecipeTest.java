...
import guru.springframework.spring5recipapp.commands.CategoryCommand;
...
import guru.springframework.spring5recipapp.domain.Difficulty;
...
public class RecipeCommandToRecipeTest {
    ...
    public void setUp() throws Exception {
        converter = new RecipeCommandToRecipe(new CategoryCommandToCategory(),
                new IngredientCommandToIngredient(new UnitOfMountCommandToUnitOfMount()),
    ...
    public void convert() throws Exception {
        ...
        assertEquals(PREP_TIME, recipe.getPreTime());
